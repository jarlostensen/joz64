...
..\zig\zig clang -c ../kernel/kernel.s
if %ERRORLEVEL% equ 0 (
    ..\zig\zig build-exe ../kernel/efi_main.zig --library kernel.o --name bootx64 -target x86_64-uefi-msvc --subsystem efi_application -femit-asm --strip
